...
MMapFile::MMapFile(const MMapFile& mapFile)
{
    ...
    mmap_base_ = mapFile.mmap_base_;
    
    mode_ = mapFile.mode_;
    access_mode_ = mapFile.access_mode_;
    filePath_ = mapFile.filePath_;
}

MMapFile::MMapFile(MMapFile&& mapFile)
{
    opened_ = mapFile.opened_;
    ...
    mmap_base_ = mapFile.mmap_base_;
    mapFile.mmap_base_ = NULL;
    
    mode_ = mapFile.mode_;
    access_mode_ = mapFile.access_mode_;
    filePath_ = move(mapFile.filePath_);
}
...
MMapFile& MMapFile::operator=(MMapFile&& mapFile)
{
    opened_ = mapFile.opened_;
    mapFile.opened_ = false;
...
void MMapFile::setAccessMode(AccessMode mode)
{
    ...
    access_mode_ = mode;
    madvise(mmap_base_, map_size_, access_mode);
}
